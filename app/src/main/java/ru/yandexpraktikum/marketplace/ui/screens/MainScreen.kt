...
fun ProductCard(
    ...
    val productImageDescription = stringResource(R.string.product_image_description, product.name)
    val actionLableDesctription = stringResource(R.string.add_product_to_cart, product.name)
    Card(
        modifier = modifier
          .fillMaxWidth()
          .semantics {
